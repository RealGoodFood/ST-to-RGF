...
function initialize_admin_new_community_form(locale, invalid_domain_message, domain_in_use_message, select_default) {
  ...
  $(form_id).validate({
    errorPlacement: function(error, element) {
		...
		rules: {
			...
			"community[domain]": {required: true, minlength: 2, maxlength: 50},
